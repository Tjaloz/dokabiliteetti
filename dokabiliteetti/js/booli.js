...
export function renderaaReseptit() {
  ...
  reseptitEl.innerHTML = booliReseptit.map(function (r) {
    ...
    return '<div class="resepti-kortti">' +
      ...
      '<div class="resepti-meta">' + pyorista(r.kokonaistilavuus, 2) + " l · " + pyorista(r.lopullinenProsentti, 1) + " % · " + pyorista(r.kokonaishinta, 2).toFixed(2) + " € · " + t("resepti_lisasi") + " " + escapeHtml(r.lisaaja) + "<br>" + escapeHtml(ainesLista) + "</div>" +
